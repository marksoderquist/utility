/*
 * This script can be used to reduce privileges when running with elevated privileges on Windows Vista and higher.
 * Run it as follows:
 *    wscript normal.js program.exe "argument1" "argument2" "argument3"
 *
...
Shell.ShellExecute(Application, Arguments, "", "open");
