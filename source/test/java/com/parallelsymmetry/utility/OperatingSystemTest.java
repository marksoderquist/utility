...
public class OperatingSystemTest extends TestCase {
	...
	public void testWindows() throws Exception {
		...
		assertEquals(OperatingSystem.Family.WINDOWS,
	...
	public void testIsProcessElevatedMac() throws Exception {
		...
		System.setProperty(OperatingSystem.ELEVATED_PRIVILEGE_KEY,
				OperatingSystem.ELEVATED_PRIVILEGE_VALUE);
		OperatingSystem.clearProcessElevatedCache();
	...
	public void testElevateProcessWindows() throws Exception {
		...
		File elevate = new File(System.getProperty("java.io.tmpdir"),
				"elevate.js");
	...
	public void testReduceProcessWindows() throws Exception {
		...
		System.setProperty(OperatingSystem.ELEVATED_PRIVILEGE_KEY,
				OperatingSystem.ELEVATED_PRIVILEGE_VALUE);
		ProcessBuilder builder = new ProcessBuilder("javaw", "-jar",
				"C:\\Program Files\\Escape\\program.jar", "-update", "false");
		...
		assertEquals(
				"\"javaw -jar \\\"C:\\Program Files\\Escape\\program.jar\\\" -update false\"",
				builder.command().get(index++));

	}

	public static final void init(String name, String arch, String version)
			throws Exception {
		Method initMethod = OperatingSystem.class.getDeclaredMethod("init",
